		...
		<div class="main overflowH">
			...
			<div class="dialongbox" id="win">
				...
				<div class="text2 overflowH">
					...
					<ul><li class="float_l">评价：</li>
						<li class="img_x2 level_star xing2 hc_edit"><input type="hidden" flag="commentLevel" name="xing" value="2">
						</li>
						<li class="hc_show"><span flag="comment">评价信息在这里显示</span></li>
					</ul>
				</div>
				<!--end行-->
				<div class="line2"></div>
			...
			<div class="table_2">
				...
				<s:iterator id="order" value="#pageVO.getData()">
					...
					<div class="line_H overflowH">
						...
						<s:if test="#order.statusVO==@com.banche.enums.OrderStatus@COMPLETE.getName()">
							<div class="list_width2 textstyle02">${order.statusVO }</div>
						</s:if>
						<s:else>
							<div class="list_width2 textstyle01">${order.statusVO }</div>
						</s:else>						
						<div class="list_width02 view_detail view_h" auth="bc_Order_viewComplete">
