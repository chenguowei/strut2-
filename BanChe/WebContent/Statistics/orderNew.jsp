...
<body>
	...
	<div class="mianbox">
		<div class="main overflowH">
			...
			<div class="table_2">
			<form id="submitForm">
				<select id="timeType" name="subform.timeType">
					<s:iterator id="timeType" value="@com.banche.enums.StatististicsTimeEnums@values()">
					<option value="${timeType.code}" <s:if test="#timeType.getCode()==#subform.getTimeType()">selected</s:if>>${timeType.name}</option>
					</s:iterator>
				</select>
			</form>
				<div id="chart"></div>
